...
/*
	public int rate(){
		//H-Function as steps of Bubblesort to sort the Matrix (transformed into a one-dimensional Array)
...
*/
	...
	public int rate(){
		//H-Function as count of Numbers in the wrong place divided by the Height of the Matrix, to ensure that it is optimistic
		int[] singleArray = this.toSingleArray();
		int errors = 0;
		for(int i = 0; i < singleArray.length; i ++){
			if(singleArray[i] != i+1) errors = errors + 1; 
		}
	...
	public GameState shiftRow(int rowNr, boolean direction){
		//Inserting the opNR at one Side of the Matrix
